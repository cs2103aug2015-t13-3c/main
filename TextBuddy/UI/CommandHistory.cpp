...
// Retrieves the previous command the user entered and place it into input texTSox
...
// changes the input texTSox text to one step forward from the past command the
