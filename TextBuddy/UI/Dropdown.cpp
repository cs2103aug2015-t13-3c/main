...
// copies the selected item in the dropdown menu into the userInput texTSox, 
...
// Performs a character by character comparison of the command keyword and the
// text in input texTSox, returns :
...
// Parses the text in input texTSox, highlights the nearest parameter with 
// the format : <.....>
