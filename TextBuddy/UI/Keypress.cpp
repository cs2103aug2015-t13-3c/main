...
//			   check if the input texTSox has parameters from autosuggest, and 
...
// Response to different keys :
// 1. [RETURN] - if the dropdown menu is active, sets the input texTSox to be 
//				 the item selected in the dropdown menu
//				 else, accepts the input texTSox text as command and process it
